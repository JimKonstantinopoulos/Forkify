...
import {Fraction} from 'fractional'; //Using fraction for ingredient.quantity to conver 0.5 to 1/2 like real recipes

class RecipeView extends View{
    _parentElement = document.querySelector('.recipe');
    _defaultError = `We couldn't find that recipe. Please try another one`;

    addHandlerRender(handler){
        //Show recipe window when either the page loads or the hash of the link changes
